...
class Scenario_test (unittest.TestCase):
	...
	def test_scenario(self):
		...
		print 'python>> scenario_test_3.py'
		...
		# Test Scenario
		self.scenarioMousePosition(972, 540) # mouse move : 972,540
		self.scenarioKeyCodeNum(773, 'key') # key press : [773] home
		self.scenarioSleep(3) # sleep for action
		self.scenarioMousePosition(532, 452) # mouse move : 532,452
		self.scenarioKeyCodeNum(773, 'key') # key press : [773] home
		self.scenarioSleep(3) # sleep for action
		self.scenarioKeyCodeNum(773, 'key') # key press : [773] home
		self.scenarioSleep(3) # sleep for action
		self.scenarioMousePosition(1192, 229) # mouse move : 1192,229
		self.scenarioKeyCodeNum(773, 'key') # key press : [773] home
		self.scenarioSleep(3) # sleep for action
		self.scenarioKeyCodeNum(773, 'key') # key press : [773] home
		self.scenarioSleep(3) # sleep for action
		...
		self.scenarioKeyCodeNum(773, 'key') # key press : [773] home
		self.scenarioSleep(3) # sleep for action
		self.scenarioMousePosition(940, 393) # mouse move : 940,393
		self.scenarioMousePosition(1914, 1034) # mouse move : 1914,1034
